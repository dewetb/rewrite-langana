...
ActiveRecord::Schema.define(version: 20150322190558) do
  ...
  add_index "references", ["employer_user_id"], name: "index_references_on_employer_user_id", using: :btree
  add_index "references", ["worker_user_id"], name: "index_references_on_worker_user_id", using: :btree
